  ...
  return (
    <>
      ...
      <header className="site-header">
        <a className="identity" href={`/${locale}/`} aria-label="CrioMant — home">
      ...
      <main id="main-content">
        <section className="hero" aria-labelledby="hero-title">
          ...
          <div className="hero-grid shell">
            ...
            <aside className="hero-manifest" aria-label="System manifest">
              ...
              <dl>
                ...
                <div><dt>DATA</dt><dd>MODULE WORKER</dd></div>
                <div><dt>LANG</dt><dd>EN / UK</dd></div>
              </dl>
              <p>{c.heroNote}</p>
            </aside>
          </div>
          <div className="proof-rail" aria-label="Verified highlights">
