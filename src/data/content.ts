...
export const projects: Project[] = [
  ...
  },
  {
    ...
    summary: {
      en: 'This portfolio rebuilt as a browser systems platform: Rust/WASM and Go, GPU graphics and neural compute, agent tools, in-tab runtimes, local data, and reproducible desktop/build experiments.',
      uk: 'Це портфоліо, перебудоване як платформа браузерних систем: Rust/WASM і Go, GPU-графіка та neural compute, agent tools, runtime у вкладці, локальні дані й відтворювані desktop/build експерименти.',
    },
    role: {
    ...
    tags: ['Vite 8 + oj parity', 'React 19', 'Rust/WASM', 'Go 1.26', 'WebGPU', 'WebMCP'],
    accent: '#8e7dff',
    accentInk: '#514596',
...
export const copy = {
  en: {
    ...
    frontierEyebrow: 'Frontier matrix / production truth',
    frontierTitle: 'Ten bets, each with a visible boundary.',
    frontierLead: 'Live capabilities, reproducible build proofs, license gates, and research fixtures are labelled separately. Nothing earns a production badge by appearing in a README.',
    labEyebrow: 'Horizon deck / browser-native experiments',
    labTitle: 'Twelve systems. Loaded only when you ask.',
    ...
    labTabs: {
      ...
      browser: ['07', 'Browser TypeScript', 'Strip and execute self-hosted TypeScript through ES Module Shims + Amaro.'],
      agent: ['08', 'Agent tools', 'Expose public projects and progress through the draft WebMCP API.'],
      spatial: ['09', 'Spatial DOM', 'Project accessible HTML controls over a GPU-rendered scene.'],
      neural: ['10', 'Neural field', 'Run a deterministic MLP through WebGPU compute with a JS fallback.'],
      container: ['11', 'Node in a tab', 'Boot a tiny WebContainer server only when licensing and isolation gates pass.'],
      component: ['12', 'Component mesh', 'Exercise a multi-language Wasm Component Model build and browser host.'],
    },
    runtimeLabels: {
      title: 'Runtime pulse',
    ...
    trajectory: [
      ['NOW', 'Horizon Lab v3 / Frontier runtime', 'Expanded the measured platform to twelve intent-loaded systems: browser TypeScript, WebMCP tools, accessible GPU co-rendering, neural compute, in-tab Node, Component Model and Deno artifacts.', 'Shipping'],
  ...
  uk: {
    ...
    proofs: [
      ...
      ['12', 'лабораторних систем за запитом'],
    ],
    ...
    frontierEyebrow: 'Frontier matrix / production truth',
    frontierTitle: 'Десять ставок із видимими межами.',
    frontierLead: 'Live-можливості, відтворювані build proofs, license gates і research fixtures позначені окремо. Жодна технологія не отримує production badge лише за появу в README.',
    labEyebrow: 'Horizon deck / браузерні експерименти',
    labTitle: 'Дванадцять систем. Лише на твій запит.',
    ...
    labTabs: {
      ...
      browser: ['07', 'TypeScript у браузері', 'Видали типи й виконай self-hosted TypeScript через ES Module Shims + Amaro.'],
      agent: ['08', 'Agent tools', 'Надай публічні проєкти й прогрес через draft WebMCP API.'],
      spatial: ['09', 'Просторовий DOM', 'Спроєктуй доступні HTML-контролери над GPU-rendered сценою.'],
      neural: ['10', 'Neural field', 'Запусти детермінований MLP через WebGPU compute з JS fallback.'],
      container: ['11', 'Node у вкладці', 'Запусти малий WebContainer server лише після license та isolation gates.'],
      component: ['12', 'Component mesh', 'Перевір multi-language Wasm Component Model build і browser host.'],
    },
    runtimeLabels: {
      title: 'Runtime pulse',
    ...
    trajectory: [
      ['ЗАРАЗ', 'Horizon Lab v3 / Frontier runtime', 'Розширив вимірювану платформу до дванадцяти систем за запитом: browser TypeScript, WebMCP tools, доступний GPU co-render, neural compute, Node у вкладці, Component Model та Deno artifacts.', 'Реліз'],
